                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="../subjects/edit.php?id=<?php echo $subject['subject_id']; ?>" class="btn btn-outline-primary">Edit</a>
                                        <a href="../subjects/delete.php?id=<?php echo $subject['subject_id']; ?>" class="btn btn-outline-danger" onclick="return confirm('Delete this subject?');">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
