...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($surname === '' || $given_name === '') {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO teachers (surname, middle_name, given_name, department_id, subject_id) VALUES (?, ?, ?, ?, ?)");
            $stmt->execute([$surname, $middle_name !== '' ? $middle_name : null, $given_name, $department_id, $subject_id]);
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h2 mb-0">Add Teacher</h1>
